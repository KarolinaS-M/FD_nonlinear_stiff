...
st.set_page_config(
    page_title="Finite Difference Method: Nonlinear Boundary Value Problem",
    layout="wide"
)
...
st.markdown(
    ...
    "schemes applied to a **nonlinear boundary value problem**."
)
...
st.info(
    "The power term introduces nonlinearity, while the linear decay parameter λ "
    "controls the speed of adjustment. The example highlights qualitative differences "
    "between one–sided and symmetric finite difference discretizations."
)
...
with st.sidebar:
    ...
    lam = st.number_input(
        "λ (linear decay parameter)", value=7.0, step=0.5, format="%.2f"
    )
...
# ======================================================
# Backward difference (implicit, one–sided)
# ======================================================
...
# ======================================================
# Central difference (symmetric stencil)
# ======================================================
...
# ======================================================
# Forward difference (explicit, one–sided)
# ======================================================
...
st.info(
    "In nonlinear boundary value problems, symmetric finite difference schemes "
    "may generate spurious oscillatory modes even when the numerical solution "
    "remains bounded. One–sided discretizations, particularly implicit ones, "
    "tend to better preserve the qualitative behavior of the continuous system."
)